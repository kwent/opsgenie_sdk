...
module OpsgenieSdk
  class MSTeamsV2Callback
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, webhook_url, conversation_id].hash
    end

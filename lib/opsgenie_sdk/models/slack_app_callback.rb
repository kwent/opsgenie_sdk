...
module OpsgenieSdk
  class SlackAppCallback
    ...
    def hash
      [alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, channel, team_name, send_description, send_routed_teams, send_tags].hash
    end

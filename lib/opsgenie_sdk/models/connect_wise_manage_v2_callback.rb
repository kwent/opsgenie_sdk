...
module OpsgenieSdk
  class ConnectWiseManageV2Callback
    ...
    attr_accessor :login_company

    attr_accessor :company_name

    attr_accessor :cwm_url
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'loginCompany')
        self.login_company = attributes[:'loginCompany']
      end
      ...
      if attributes.has_key?(:'cwmUrl')
        self.cwm_url = attributes[:'cwmUrl']
      end
      ...
      if attributes.has_key?(:'boardName')
        self.board_name = attributes[:'boardName']
      end
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, public_key, private_key, login_company, company_name, cwm_url, company_id, board_name, board_id].hash
    end

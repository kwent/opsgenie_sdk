...
module OpsgenieSdk
  class SlackAppIntegration
    ...
    attr_accessor :send_description

    attr_accessor :send_routed_teams

    attr_accessor :send_tags
    ...
    attr_accessor :require_matching_user

    attr_accessor :execute_commands

    attr_accessor :use_slack_buttons
    ...
    def self.swagger_types
      {
        ...
        :'require_matching_user' => :'BOOLEAN',
        :'execute_commands' => :'BOOLEAN',
        :'use_slack_buttons' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'teamName')
        self.team_name = attributes[:'teamName']
      end

      if attributes.has_key?(:'sendDescription')
        self.send_description = attributes[:'sendDescription']
      end

      if attributes.has_key?(:'sendRoutedTeams')
        self.send_routed_teams = attributes[:'sendRoutedTeams']
      end

      if attributes.has_key?(:'sendTags')
        self.send_tags = attributes[:'sendTags']
      end
      ...
      if attributes.has_key?(:'requireMatchingUser')
        self.require_matching_user = attributes[:'requireMatchingUser']
      end
      ...
      if attributes.has_key?(:'useSlackButtons')
        self.use_slack_buttons = attributes[:'useSlackButtons']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          send_description == o.send_description &&
          send_routed_teams == o.send_routed_teams &&
          send_tags == o.send_tags &&
          type == o.type &&
          id == o.id &&
          name == o.name &&
          enabled == o.enabled &&
          ...
          require_matching_user == o.require_matching_user &&
          execute_commands == o.execute_commands &&
          use_slack_buttons == o.use_slack_buttons
    end
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, ignore_responders_from_payload, ignore_tags_from_payload, ignore_extra_properties_from_payload, responders, priority, custom_priority, tags, extra_properties, assigned_team, feature_type, allow_configuration_access, allow_read_access, allow_write_access, allow_delete_access, alert_filter, alert_actions, callback_type, send_alert_actions, bidirectional_callback_type, channel, team_name, send_description, send_routed_teams, send_tags, type, id, name, enabled, owner_team, is_global, _read_only, require_matching_user, execute_commands, use_slack_buttons].hash
    end

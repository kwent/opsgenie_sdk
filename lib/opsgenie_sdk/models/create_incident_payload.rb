...
module OpsgenieSdk
  class CreateIncidentPayload
    ...
    attr_accessor :status_page_entry
    ...
    def self.swagger_types
      {
        ...
        :'note' => :'String',
        :'service_id' => :'String',
        :'status_page_entry' => :'Hash<String, StatusPageEntry>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'statusPageEntry')
        if (value = attributes[:'statusPageEntry']).is_a?(Hash)
          self.status_page_entry = value
        end
      end

      if attributes.has_key?(:'notifyStakeholders')
        self.notify_stakeholders = attributes[:'notifyStakeholders']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status_page_entry == o.status_page_entry &&
          notify_stakeholders == o.notify_stakeholders
    end
    ...
    def hash
      [message, description, responders, tags, details, priority, note, service_id, status_page_entry, notify_stakeholders].hash
    end

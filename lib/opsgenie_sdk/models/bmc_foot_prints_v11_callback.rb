...
module OpsgenieSdk
  class BMCFootPrintsV11Callback
    ...
    attr_accessor :incident_workspace_id

    attr_accessor :problem_workspace_id
    ...
    def self.swagger_types
      {
        ...
        :'username' => :'String',
        :'password' => :'String',
        :'incident_workspace_id' => :'String',
        :'problem_workspace_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'incidentWorkspaceId')
        self.incident_workspace_id = attributes[:'incidentWorkspaceId']
      end

      if attributes.has_key?(:'problemWorkspaceId')
        self.problem_workspace_id = attributes[:'problemWorkspaceId']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          username == o.username &&
          password == o.password &&
          incident_workspace_id == o.incident_workspace_id &&
          problem_workspace_id == o.problem_workspace_id
    end
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, url, username, password, incident_workspace_id, problem_workspace_id].hash
    end

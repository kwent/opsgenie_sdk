...
module OpsgenieSdk
  class ConnectWiseManageCallback
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, public_key, private_key, login_company, company_name, cwm_url, company_id].hash
    end

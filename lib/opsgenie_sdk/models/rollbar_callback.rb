...
module OpsgenieSdk
  class RollbarCallback
    ...
    attr_accessor :write_access_token
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'writeAccessToken')
        self.write_access_token = attributes[:'writeAccessToken']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          write_access_token == o.write_access_token
    end
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, write_access_token].hash
    end

...
module OpsgenieSdk
  class RingCentralGlipCallback
    ...
    attr_accessor :add_alert_details

    attr_accessor :add_alert_description

    attr_accessor :base_webhook_callback_type
    ...
    def self.swagger_types
      {
        ...
        :'add_alert_details' => :'BOOLEAN',
        :'add_alert_description' => :'BOOLEAN',
        :'base_webhook_callback_type' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'addAlertDetails')
        self.add_alert_details = attributes[:'addAlertDetails']
      end

      if attributes.has_key?(:'addAlertDescription')
        self.add_alert_description = attributes[:'addAlertDescription']
      end

      if attributes.has_key?(:'base-webhook-callback-type')
        self.base_webhook_callback_type = attributes[:'base-webhook-callback-type']
      end
    end
    ...
    def valid?
      ...
      base_webhook_callback_type_validator = EnumAttributeValidator.new('String', ['flock-callback', 'kore-callback', 'moxtra-callback', 'ring-central-glip-callback', 'statusy-callback', 'webhook-callback'])
      return false unless base_webhook_callback_type_validator.valid?(@base_webhook_callback_type)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] base_webhook_callback_type Object to be assigned
    def base_webhook_callback_type=(base_webhook_callback_type)
      validator = EnumAttributeValidator.new('String', ['flock-callback', 'kore-callback', 'moxtra-callback', 'ring-central-glip-callback', 'statusy-callback', 'webhook-callback'])
      unless validator.valid?(base_webhook_callback_type)
        fail ArgumentError, 'invalid value for "base_webhook_callback_type", must be one of #{validator.allowable_values}.'
      end
      @base_webhook_callback_type = base_webhook_callback_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          url == o.url &&
          headers == o.headers &&
          add_alert_details == o.add_alert_details &&
          add_alert_description == o.add_alert_description &&
          base_webhook_callback_type == o.base_webhook_callback_type
    end
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, url, headers, add_alert_details, add_alert_description, base_webhook_callback_type].hash
    end

...
module OpsgenieSdk
  class Service
    ...
    def valid?
      ...
      visibility_validator = EnumAttributeValidator.new('String', ['TEAM_MEMBERS', 'OPSGENIE_USERS'])
    ...
    def visibility=(visibility)
      validator = EnumAttributeValidator.new('String', ['TEAM_MEMBERS', 'OPSGENIE_USERS'])
    ...
    def hash
      [id, name, team_id, description, visibility, tags].hash
    end

...
module OpsgenieSdk
  class MSTeamsIntegration
    ...
    def hash
      [suppress_notifications, ignore_teams_from_payload, ignore_recipients_from_payload, recipients, is_advanced, ignore_responders_from_payload, ignore_tags_from_payload, ignore_extra_properties_from_payload, responders, priority, custom_priority, tags, extra_properties, assigned_team, feature_type, allow_configuration_access, allow_read_access, allow_write_access, allow_delete_access, alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, webhook_url, type, id, name, enabled, owner_team, is_global, _read_only, require_matching_user, execute_commands, tenant_id].hash
    end

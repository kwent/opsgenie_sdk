...
module OpsgenieSdk
  class BMCRemedyCallback
    ...
    attr_accessor :midtier_server_url
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'midtierServerUrl')
        self.midtier_server_url = attributes[:'midtierServerUrl']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          username == o.username &&
          password == o.password &&
          midtier_server_url == o.midtier_server_url &&
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, username, password, midtier_server_url, server_name].hash
    end

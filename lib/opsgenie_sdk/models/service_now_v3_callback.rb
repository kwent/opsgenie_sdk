...
module OpsgenieSdk
  class ServiceNowV3Callback
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'instanceSubdomain')
        self.instance_subdomain = attributes[:'instanceSubdomain']
      end
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, instance_subdomain, user_id, password].hash
    end

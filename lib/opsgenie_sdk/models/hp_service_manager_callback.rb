...
module OpsgenieSdk
  class HPServiceManagerCallback
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'apiKet')
        self.api_ket = attributes[:'apiKet']
      end

      if attributes.has_key?(:'baseDomain')
        self.base_domain = attributes[:'baseDomain']
      end
    end
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, api_ket, base_domain].hash
    end

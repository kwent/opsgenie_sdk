...
module OpsgenieSdk
  class ServiceIncidentCondition
    ...
    def valid?
      ...
      field_validator = EnumAttributeValidator.new('String', ['message', 'description', 'tags', 'extra-properties', 'recipients', 'teams', 'priority'])
    ...
    def field=(field)
      validator = EnumAttributeValidator.new('String', ['message', 'description', 'tags', 'extra-properties', 'recipients', 'teams', 'priority'])
    ...
    def hash
      [field, key, _not, operation, expected_value].hash
    end

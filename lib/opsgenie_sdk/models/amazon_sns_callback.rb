...
module OpsgenieSdk
  class AmazonSnsCallback
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'newConfType')
        self.new_conf_type = attributes[:'newConfType']
      end
    end
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, topic_arn, region, new_conf_type].hash
    end

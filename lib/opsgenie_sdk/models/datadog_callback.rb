...
module OpsgenieSdk
  class DatadogCallback
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sendToEU')
        self.send_to_eu = attributes[:'sendToEU']
      end
    end
    ...
    def hash
      [alert_filter, forwarding_enabled, forwarding_action_mappings, callback_type, updates_action_mappings, updates_enabled, bidirectional_callback_type, token, send_to_eu].hash
    end

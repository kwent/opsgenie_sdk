...
# Unit tests for OpsgenieSdk::StackStormIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StackStormIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::StackStormIntegration.new
  end
  ...
  describe 'test an instance of StackStormIntegration' do
    it 'should create an instance of StackStormIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::StackStormIntegration)
    end
  end

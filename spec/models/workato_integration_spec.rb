...
# Unit tests for OpsgenieSdk::WorkatoIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WorkatoIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::WorkatoIntegration.new
  end
  ...
  describe 'test an instance of WorkatoIntegration' do
    it 'should create an instance of WorkatoIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::WorkatoIntegration)
    end
  end

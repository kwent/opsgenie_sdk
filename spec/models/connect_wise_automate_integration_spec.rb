...
# Unit tests for OpsgenieSdk::ConnectWiseAutomateIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConnectWiseAutomateIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ConnectWiseAutomateIntegration.new
  end
  ...
  describe 'test an instance of ConnectWiseAutomateIntegration' do
    it 'should create an instance of ConnectWiseAutomateIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ConnectWiseAutomateIntegration)
    end
  end

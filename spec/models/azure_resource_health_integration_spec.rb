...
# Unit tests for OpsgenieSdk::AzureResourceHealthIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AzureResourceHealthIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AzureResourceHealthIntegration.new
  end
  ...
  describe 'test an instance of AzureResourceHealthIntegration' do
    it 'should create an instance of AzureResourceHealthIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AzureResourceHealthIntegration)
    end
  end

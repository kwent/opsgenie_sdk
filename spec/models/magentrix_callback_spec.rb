...
# Unit tests for OpsgenieSdk::MagentrixCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MagentrixCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::MagentrixCallback.new
  end
  ...
  describe 'test an instance of MagentrixCallback' do
    it 'should create an instance of MagentrixCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::MagentrixCallback)
    end
  end

...
# Unit tests for OpsgenieSdk::EmailBasedIncomingFeature
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailBasedIncomingFeature' do
  before do
    # run before each test
    @instance = OpsgenieSdk::EmailBasedIncomingFeature.new
  end
  ...
  describe 'test an instance of EmailBasedIncomingFeature' do
    it 'should create an instance of EmailBasedIncomingFeature' do
      expect(@instance).to be_instance_of(OpsgenieSdk::EmailBasedIncomingFeature)
    end
  end

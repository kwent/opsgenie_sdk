...
# Unit tests for OpsgenieSdk::ConnectWiseManageCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConnectWiseManageCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ConnectWiseManageCallback.new
  end
  ...
  describe 'test an instance of ConnectWiseManageCallback' do
    it 'should create an instance of ConnectWiseManageCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ConnectWiseManageCallback)
    end
  end

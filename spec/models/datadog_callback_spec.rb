...
# Unit tests for OpsgenieSdk::DatadogCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DatadogCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::DatadogCallback.new
  end
  ...
  describe 'test an instance of DatadogCallback' do
    it 'should create an instance of DatadogCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::DatadogCallback)
    end
  end
  ...
  describe 'test attribute "send_to_eu"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

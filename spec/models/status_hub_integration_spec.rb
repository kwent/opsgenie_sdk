...
# Unit tests for OpsgenieSdk::StatusHubIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusHubIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::StatusHubIntegration.new
  end
  ...
  describe 'test an instance of StatusHubIntegration' do
    it 'should create an instance of StatusHubIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::StatusHubIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::UpdownIOIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdownIOIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::UpdownIOIntegration.new
  end
  ...
  describe 'test an instance of UpdownIOIntegration' do
    it 'should create an instance of UpdownIOIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::UpdownIOIntegration)
    end
  end

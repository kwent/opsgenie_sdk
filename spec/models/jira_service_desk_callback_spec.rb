...
# Unit tests for OpsgenieSdk::JiraServiceDeskCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JiraServiceDeskCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::JiraServiceDeskCallback.new
  end
  ...
  describe 'test an instance of JiraServiceDeskCallback' do
    it 'should create an instance of JiraServiceDeskCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::JiraServiceDeskCallback)
    end
  end

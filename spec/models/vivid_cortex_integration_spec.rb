...
# Unit tests for OpsgenieSdk::VividCortexIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VividCortexIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::VividCortexIntegration.new
  end
  ...
  describe 'test an instance of VividCortexIntegration' do
    it 'should create an instance of VividCortexIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::VividCortexIntegration)
    end
  end

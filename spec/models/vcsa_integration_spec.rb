...
# Unit tests for OpsgenieSdk::VCSAIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VCSAIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::VCSAIntegration.new
  end
  ...
  describe 'test an instance of VCSAIntegration' do
    it 'should create an instance of VCSAIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::VCSAIntegration)
    end
  end

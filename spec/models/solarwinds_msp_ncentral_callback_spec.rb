...
# Unit tests for OpsgenieSdk::SolarwindsMSPNcentralCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SolarwindsMSPNcentralCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SolarwindsMSPNcentralCallback.new
  end
  ...
  describe 'test an instance of SolarwindsMSPNcentralCallback' do
    it 'should create an instance of SolarwindsMSPNcentralCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SolarwindsMSPNcentralCallback)
    end
  end

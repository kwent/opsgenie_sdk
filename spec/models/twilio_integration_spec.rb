...
# Unit tests for OpsgenieSdk::TwilioIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TwilioIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::TwilioIntegration.new
  end
  ...
  describe 'test an instance of TwilioIntegration' do
    it 'should create an instance of TwilioIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::TwilioIntegration)
    end
  end

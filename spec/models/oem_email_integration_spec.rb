...
# Unit tests for OpsgenieSdk::OEMEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OEMEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::OEMEmailIntegration.new
  end
  ...
  describe 'test an instance of OEMEmailIntegration' do
    it 'should create an instance of OEMEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::OEMEmailIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::TidewaysIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TidewaysIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::TidewaysIntegration.new
  end
  ...
  describe 'test an instance of TidewaysIntegration' do
    it 'should create an instance of TidewaysIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::TidewaysIntegration)
    end
  end

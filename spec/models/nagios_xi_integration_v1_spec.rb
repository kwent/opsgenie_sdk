...
# Unit tests for OpsgenieSdk::NagiosXIIntegrationV1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NagiosXIIntegrationV1' do
  before do
    # run before each test
    @instance = OpsgenieSdk::NagiosXIIntegrationV1.new
  end
  ...
  describe 'test an instance of NagiosXIIntegrationV1' do
    it 'should create an instance of NagiosXIIntegrationV1' do
      expect(@instance).to be_instance_of(OpsgenieSdk::NagiosXIIntegrationV1)
    end
  end

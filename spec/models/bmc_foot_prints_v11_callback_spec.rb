...
# Unit tests for OpsgenieSdk::BMCFootPrintsV11Callback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BMCFootPrintsV11Callback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::BMCFootPrintsV11Callback.new
  end
  ...
  describe 'test an instance of BMCFootPrintsV11Callback' do
    it 'should create an instance of BMCFootPrintsV11Callback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::BMCFootPrintsV11Callback)
    end
  end
  ...
  describe 'test attribute "incident_workspace_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "problem_workspace_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

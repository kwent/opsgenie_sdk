...
# Unit tests for OpsgenieSdk::ZyrionIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZyrionIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ZyrionIntegration.new
  end
  ...
  describe 'test an instance of ZyrionIntegration' do
    it 'should create an instance of ZyrionIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ZyrionIntegration)
    end
  end

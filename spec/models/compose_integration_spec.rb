...
# Unit tests for OpsgenieSdk::ComposeIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ComposeIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ComposeIntegration.new
  end
  ...
  describe 'test an instance of ComposeIntegration' do
    it 'should create an instance of ComposeIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ComposeIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::SentryIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SentryIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SentryIntegration.new
  end
  ...
  describe 'test an instance of SentryIntegration' do
    it 'should create an instance of SentryIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SentryIntegration)
    end
  end

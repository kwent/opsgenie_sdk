...
# Unit tests for OpsgenieSdk::FreshdeskIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FreshdeskIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::FreshdeskIntegration.new
  end
  ...
  describe 'test an instance of FreshdeskIntegration' do
    it 'should create an instance of FreshdeskIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::FreshdeskIntegration)
    end
  end

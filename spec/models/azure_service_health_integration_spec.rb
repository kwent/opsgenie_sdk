...
# Unit tests for OpsgenieSdk::AzureServiceHealthIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AzureServiceHealthIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AzureServiceHealthIntegration.new
  end
  ...
  describe 'test an instance of AzureServiceHealthIntegration' do
    it 'should create an instance of AzureServiceHealthIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AzureServiceHealthIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::ListIncidentsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListIncidentsResponse' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ListIncidentsResponse.new
  end
  ...
  describe 'test an instance of ListIncidentsResponse' do
    it 'should create an instance of ListIncidentsResponse' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ListIncidentsResponse)
    end
  end

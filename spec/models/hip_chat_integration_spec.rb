...
# Unit tests for OpsgenieSdk::HipChatIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HipChatIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::HipChatIntegration.new
  end
  ...
  describe 'test an instance of HipChatIntegration' do
    it 'should create an instance of HipChatIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::HipChatIntegration)
    end
  end

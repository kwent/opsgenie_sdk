...
# Unit tests for OpsgenieSdk::InstanaIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InstanaIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::InstanaIntegration.new
  end
  ...
  describe 'test an instance of InstanaIntegration' do
    it 'should create an instance of InstanaIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::InstanaIntegration)
    end
  end

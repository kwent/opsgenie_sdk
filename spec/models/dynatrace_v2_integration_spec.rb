...
# Unit tests for OpsgenieSdk::DynatraceV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DynatraceV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::DynatraceV2Integration.new
  end
  ...
  describe 'test an instance of DynatraceV2Integration' do
    it 'should create an instance of DynatraceV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::DynatraceV2Integration)
    end
  end

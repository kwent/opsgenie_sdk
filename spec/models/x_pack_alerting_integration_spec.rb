...
# Unit tests for OpsgenieSdk::XPackAlertingIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XPackAlertingIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::XPackAlertingIntegration.new
  end
  ...
  describe 'test an instance of XPackAlertingIntegration' do
    it 'should create an instance of XPackAlertingIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::XPackAlertingIntegration)
    end
  end

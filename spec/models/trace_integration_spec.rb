...
# Unit tests for OpsgenieSdk::TraceIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TraceIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::TraceIntegration.new
  end
  ...
  describe 'test an instance of TraceIntegration' do
    it 'should create an instance of TraceIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::TraceIntegration)
    end
  end

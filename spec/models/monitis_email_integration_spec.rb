...
# Unit tests for OpsgenieSdk::MonitisEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MonitisEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::MonitisEmailIntegration.new
  end
  ...
  describe 'test an instance of MonitisEmailIntegration' do
    it 'should create an instance of MonitisEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::MonitisEmailIntegration)
    end
  end

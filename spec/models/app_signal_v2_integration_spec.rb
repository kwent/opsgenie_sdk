...
# Unit tests for OpsgenieSdk::AppSignalV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AppSignalV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AppSignalV2Integration.new
  end
  ...
  describe 'test an instance of AppSignalV2Integration' do
    it 'should create an instance of AppSignalV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AppSignalV2Integration)
    end
  end

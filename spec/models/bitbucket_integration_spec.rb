...
# Unit tests for OpsgenieSdk::BitbucketIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BitbucketIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::BitbucketIntegration.new
  end
  ...
  describe 'test an instance of BitbucketIntegration' do
    it 'should create an instance of BitbucketIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::BitbucketIntegration)
    end
  end

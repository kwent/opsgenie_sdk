...
# Unit tests for OpsgenieSdk::ServiceNowIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceNowIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ServiceNowIntegration.new
  end
  ...
  describe 'test an instance of ServiceNowIntegration' do
    it 'should create an instance of ServiceNowIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ServiceNowIntegration)
    end
  end

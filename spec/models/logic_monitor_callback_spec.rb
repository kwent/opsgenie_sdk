...
# Unit tests for OpsgenieSdk::LogicMonitorCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LogicMonitorCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::LogicMonitorCallback.new
  end
  ...
  describe 'test an instance of LogicMonitorCallback' do
    it 'should create an instance of LogicMonitorCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::LogicMonitorCallback)
    end
  end

...
# Unit tests for OpsgenieSdk::MattermostIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MattermostIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::MattermostIntegration.new
  end
  ...
  describe 'test an instance of MattermostIntegration' do
    it 'should create an instance of MattermostIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::MattermostIntegration)
    end
  end

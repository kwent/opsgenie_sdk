...
# Unit tests for OpsgenieSdk::NagiosXIV2Callback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NagiosXIV2Callback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::NagiosXIV2Callback.new
  end
  ...
  describe 'test an instance of NagiosXIV2Callback' do
    it 'should create an instance of NagiosXIV2Callback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::NagiosXIV2Callback)
    end
  end

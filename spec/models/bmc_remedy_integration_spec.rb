...
# Unit tests for OpsgenieSdk::BMCRemedyIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BMCRemedyIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::BMCRemedyIntegration.new
  end
  ...
  describe 'test an instance of BMCRemedyIntegration' do
    it 'should create an instance of BMCRemedyIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::BMCRemedyIntegration)
    end
  end

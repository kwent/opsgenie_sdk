...
# Unit tests for OpsgenieSdk::RollbarCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RollbarCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::RollbarCallback.new
  end
  ...
  describe 'test an instance of RollbarCallback' do
    it 'should create an instance of RollbarCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::RollbarCallback)
    end
  end
  ...
  describe 'test attribute "write_access_token"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

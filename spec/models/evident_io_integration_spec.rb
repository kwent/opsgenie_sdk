...
# Unit tests for OpsgenieSdk::EvidentIOIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EvidentIOIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::EvidentIOIntegration.new
  end
  ...
  describe 'test an instance of EvidentIOIntegration' do
    it 'should create an instance of EvidentIOIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::EvidentIOIntegration)
    end
  end

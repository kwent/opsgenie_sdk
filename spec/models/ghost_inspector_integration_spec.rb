...
# Unit tests for OpsgenieSdk::GhostInspectorIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GhostInspectorIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::GhostInspectorIntegration.new
  end
  ...
  describe 'test an instance of GhostInspectorIntegration' do
    it 'should create an instance of GhostInspectorIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::GhostInspectorIntegration)
    end
  end

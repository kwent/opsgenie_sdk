...
# Unit tests for OpsgenieSdk::AmazonEc2AutoScalingIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonEc2AutoScalingIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AmazonEc2AutoScalingIntegration.new
  end
  ...
  describe 'test an instance of AmazonEc2AutoScalingIntegration' do
    it 'should create an instance of AmazonEc2AutoScalingIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AmazonEc2AutoScalingIntegration)
    end
  end

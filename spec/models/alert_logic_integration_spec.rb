...
# Unit tests for OpsgenieSdk::AlertLogicIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AlertLogicIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AlertLogicIntegration.new
  end
  ...
  describe 'test an instance of AlertLogicIntegration' do
    it 'should create an instance of AlertLogicIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AlertLogicIntegration)
    end
  end

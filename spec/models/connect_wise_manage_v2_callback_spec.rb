...
# Unit tests for OpsgenieSdk::ConnectWiseManageV2Callback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConnectWiseManageV2Callback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ConnectWiseManageV2Callback.new
  end
  ...
  describe 'test an instance of ConnectWiseManageV2Callback' do
    it 'should create an instance of ConnectWiseManageV2Callback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ConnectWiseManageV2Callback)
    end
  end
  ...
  describe 'test attribute "login_company"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "cwm_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

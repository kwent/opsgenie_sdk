...
# Unit tests for OpsgenieSdk::TimeOfDayRestrictionInterval
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimeOfDayRestrictionInterval' do
  before do
    # run before each test
    @instance = OpsgenieSdk::TimeOfDayRestrictionInterval.new
  end
  ...
  describe 'test an instance of TimeOfDayRestrictionInterval' do
    it 'should create an instance of TimeOfDayRestrictionInterval' do
      expect(@instance).to be_instance_of(OpsgenieSdk::TimeOfDayRestrictionInterval)
    end
  end

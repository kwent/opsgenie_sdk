...
# Unit tests for OpsgenieSdk::SignalSciencesIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignalSciencesIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SignalSciencesIntegration.new
  end
  ...
  describe 'test an instance of SignalSciencesIntegration' do
    it 'should create an instance of SignalSciencesIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SignalSciencesIntegration)
    end
  end

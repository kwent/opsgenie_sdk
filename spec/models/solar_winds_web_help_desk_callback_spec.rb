...
# Unit tests for OpsgenieSdk::SolarWindsWebHelpDeskCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SolarWindsWebHelpDeskCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SolarWindsWebHelpDeskCallback.new
  end
  ...
  describe 'test an instance of SolarWindsWebHelpDeskCallback' do
    it 'should create an instance of SolarWindsWebHelpDeskCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SolarWindsWebHelpDeskCallback)
    end
  end

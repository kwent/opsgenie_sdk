...
# Unit tests for OpsgenieSdk::LookerIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LookerIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::LookerIntegration.new
  end
  ...
  describe 'test an instance of LookerIntegration' do
    it 'should create an instance of LookerIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::LookerIntegration)
    end
  end

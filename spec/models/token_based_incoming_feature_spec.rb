...
# Unit tests for OpsgenieSdk::TokenBasedIncomingFeature
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TokenBasedIncomingFeature' do
  before do
    # run before each test
    @instance = OpsgenieSdk::TokenBasedIncomingFeature.new
  end
  ...
  describe 'test an instance of TokenBasedIncomingFeature' do
    it 'should create an instance of TokenBasedIncomingFeature' do
      expect(@instance).to be_instance_of(OpsgenieSdk::TokenBasedIncomingFeature)
    end
  end

...
# Unit tests for OpsgenieSdk::SplunkCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SplunkCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SplunkCallback.new
  end
  ...
  describe 'test an instance of SplunkCallback' do
    it 'should create an instance of SplunkCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SplunkCallback)
    end
  end

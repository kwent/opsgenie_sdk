...
# Unit tests for OpsgenieSdk::KapacitorIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KapacitorIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::KapacitorIntegration.new
  end
  ...
  describe 'test an instance of KapacitorIntegration' do
    it 'should create an instance of KapacitorIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::KapacitorIntegration)
    end
  end

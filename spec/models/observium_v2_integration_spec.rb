...
# Unit tests for OpsgenieSdk::ObserviumV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ObserviumV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ObserviumV2Integration.new
  end
  ...
  describe 'test an instance of ObserviumV2Integration' do
    it 'should create an instance of ObserviumV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ObserviumV2Integration)
    end
  end

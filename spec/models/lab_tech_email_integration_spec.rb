...
# Unit tests for OpsgenieSdk::LabTechEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabTechEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::LabTechEmailIntegration.new
  end
  ...
  describe 'test an instance of LabTechEmailIntegration' do
    it 'should create an instance of LabTechEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::LabTechEmailIntegration)
    end
  end

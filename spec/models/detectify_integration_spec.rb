...
# Unit tests for OpsgenieSdk::DetectifyIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DetectifyIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::DetectifyIntegration.new
  end
  ...
  describe 'test an instance of DetectifyIntegration' do
    it 'should create an instance of DetectifyIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::DetectifyIntegration)
    end
  end

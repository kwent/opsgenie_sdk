...
# Unit tests for OpsgenieSdk::ServiceNowV2Callback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceNowV2Callback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ServiceNowV2Callback.new
  end
  ...
  describe 'test an instance of ServiceNowV2Callback' do
    it 'should create an instance of ServiceNowV2Callback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ServiceNowV2Callback)
    end
  end

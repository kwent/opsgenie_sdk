...
# Unit tests for OpsgenieSdk::NagiosIntegrationV2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NagiosIntegrationV2' do
  before do
    # run before each test
    @instance = OpsgenieSdk::NagiosIntegrationV2.new
  end
  ...
  describe 'test an instance of NagiosIntegrationV2' do
    it 'should create an instance of NagiosIntegrationV2' do
      expect(@instance).to be_instance_of(OpsgenieSdk::NagiosIntegrationV2)
    end
  end

...
# Unit tests for OpsgenieSdk::CopperEggIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CopperEggIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::CopperEggIntegration.new
  end
  ...
  describe 'test an instance of CopperEggIntegration' do
    it 'should create an instance of CopperEggIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::CopperEggIntegration)
    end
  end

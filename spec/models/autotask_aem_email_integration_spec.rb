...
# Unit tests for OpsgenieSdk::AutotaskAEMEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AutotaskAEMEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AutotaskAEMEmailIntegration.new
  end
  ...
  describe 'test an instance of AutotaskAEMEmailIntegration' do
    it 'should create an instance of AutotaskAEMEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AutotaskAEMEmailIntegration)
    end
  end

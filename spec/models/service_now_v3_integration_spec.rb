...
# Unit tests for OpsgenieSdk::ServiceNowV3Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceNowV3Integration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ServiceNowV3Integration.new
  end
  ...
  describe 'test an instance of ServiceNowV3Integration' do
    it 'should create an instance of ServiceNowV3Integration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ServiceNowV3Integration)
    end
  end

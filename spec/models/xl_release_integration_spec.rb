...
# Unit tests for OpsgenieSdk::XLReleaseIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XLReleaseIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::XLReleaseIntegration.new
  end
  ...
  describe 'test an instance of XLReleaseIntegration' do
    it 'should create an instance of XLReleaseIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::XLReleaseIntegration)
    end
  end

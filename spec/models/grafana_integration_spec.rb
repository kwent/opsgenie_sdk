...
# Unit tests for OpsgenieSdk::GrafanaIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GrafanaIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::GrafanaIntegration.new
  end
  ...
  describe 'test an instance of GrafanaIntegration' do
    it 'should create an instance of GrafanaIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::GrafanaIntegration)
    end
  end

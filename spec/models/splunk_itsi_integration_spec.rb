...
# Unit tests for OpsgenieSdk::SplunkITSIIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SplunkITSIIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SplunkITSIIntegration.new
  end
  ...
  describe 'test an instance of SplunkITSIIntegration' do
    it 'should create an instance of SplunkITSIIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SplunkITSIIntegration)
    end
  end

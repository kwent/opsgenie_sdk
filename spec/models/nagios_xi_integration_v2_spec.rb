...
# Unit tests for OpsgenieSdk::NagiosXIIntegrationV2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NagiosXIIntegrationV2' do
  before do
    # run before each test
    @instance = OpsgenieSdk::NagiosXIIntegrationV2.new
  end
  ...
  describe 'test an instance of NagiosXIIntegrationV2' do
    it 'should create an instance of NagiosXIIntegrationV2' do
      expect(@instance).to be_instance_of(OpsgenieSdk::NagiosXIIntegrationV2)
    end
  end

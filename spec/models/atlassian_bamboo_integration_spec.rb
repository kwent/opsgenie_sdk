...
# Unit tests for OpsgenieSdk::AtlassianBambooIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AtlassianBambooIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AtlassianBambooIntegration.new
  end
  ...
  describe 'test an instance of AtlassianBambooIntegration' do
    it 'should create an instance of AtlassianBambooIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AtlassianBambooIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::WavefrontIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WavefrontIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::WavefrontIntegration.new
  end
  ...
  describe 'test an instance of WavefrontIntegration' do
    it 'should create an instance of WavefrontIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::WavefrontIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::ZenossCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZenossCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ZenossCallback.new
  end
  ...
  describe 'test an instance of ZenossCallback' do
    it 'should create an instance of ZenossCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ZenossCallback)
    end
  end

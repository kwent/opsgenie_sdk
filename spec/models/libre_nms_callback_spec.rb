...
# Unit tests for OpsgenieSdk::LibreNMSCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LibreNMSCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::LibreNMSCallback.new
  end
  ...
  describe 'test an instance of LibreNMSCallback' do
    it 'should create an instance of LibreNMSCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::LibreNMSCallback)
    end
  end

...
# Unit tests for OpsgenieSdk::PingdomIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PingdomIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::PingdomIntegration.new
  end
  ...
  describe 'test an instance of PingdomIntegration' do
    it 'should create an instance of PingdomIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::PingdomIntegration)
    end
  end

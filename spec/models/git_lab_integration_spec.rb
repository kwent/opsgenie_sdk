...
# Unit tests for OpsgenieSdk::GitLabIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GitLabIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::GitLabIntegration.new
  end
  ...
  describe 'test an instance of GitLabIntegration' do
    it 'should create an instance of GitLabIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::GitLabIntegration)
    end
  end

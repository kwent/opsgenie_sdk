...
# Unit tests for OpsgenieSdk::LibreNMSIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LibreNMSIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::LibreNMSIntegration.new
  end
  ...
  describe 'test an instance of LibreNMSIntegration' do
    it 'should create an instance of LibreNMSIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::LibreNMSIntegration)
    end
  end

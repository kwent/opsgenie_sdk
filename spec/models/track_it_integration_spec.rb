...
# Unit tests for OpsgenieSdk::TrackItIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackItIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::TrackItIntegration.new
  end
  ...
  describe 'test an instance of TrackItIntegration' do
    it 'should create an instance of TrackItIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::TrackItIntegration)
    end
  end

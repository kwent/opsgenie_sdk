...
# Unit tests for OpsgenieSdk::ApiIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ApiIntegration.new
  end
  ...
  describe 'test an instance of ApiIntegration' do
    it 'should create an instance of ApiIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ApiIntegration)
    end
  end
  ...
  describe 'test attribute "is_default_integration"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

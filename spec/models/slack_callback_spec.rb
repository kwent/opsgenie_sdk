...
# Unit tests for OpsgenieSdk::SlackCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SlackCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SlackCallback.new
  end
  ...
  describe 'test an instance of SlackCallback' do
    it 'should create an instance of SlackCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SlackCallback)
    end
  end

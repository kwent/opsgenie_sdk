...
# Unit tests for OpsgenieSdk::JenkinsIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JenkinsIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::JenkinsIntegration.new
  end
  ...
  describe 'test an instance of JenkinsIntegration' do
    it 'should create an instance of JenkinsIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::JenkinsIntegration)
    end
  end

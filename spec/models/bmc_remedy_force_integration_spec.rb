...
# Unit tests for OpsgenieSdk::BMCRemedyForceIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BMCRemedyForceIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::BMCRemedyForceIntegration.new
  end
  ...
  describe 'test an instance of BMCRemedyForceIntegration' do
    it 'should create an instance of BMCRemedyForceIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::BMCRemedyForceIntegration)
    end
  end

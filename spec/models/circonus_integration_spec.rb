...
# Unit tests for OpsgenieSdk::CirconusIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CirconusIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::CirconusIntegration.new
  end
  ...
  describe 'test an instance of CirconusIntegration' do
    it 'should create an instance of CirconusIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::CirconusIntegration)
    end
  end

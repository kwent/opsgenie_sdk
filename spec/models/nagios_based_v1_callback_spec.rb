...
# Unit tests for OpsgenieSdk::NagiosBasedV1Callback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NagiosBasedV1Callback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::NagiosBasedV1Callback.new
  end
  ...
  describe 'test an instance of NagiosBasedV1Callback' do
    it 'should create an instance of NagiosBasedV1Callback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::NagiosBasedV1Callback)
    end
  end

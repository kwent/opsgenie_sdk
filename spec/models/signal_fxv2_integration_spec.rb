...
# Unit tests for OpsgenieSdk::SignalFXV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignalFXV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SignalFXV2Integration.new
  end
  ...
  describe 'test an instance of SignalFXV2Integration' do
    it 'should create an instance of SignalFXV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SignalFXV2Integration)
    end
  end

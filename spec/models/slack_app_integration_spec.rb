...
# Unit tests for OpsgenieSdk::SlackAppIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SlackAppIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SlackAppIntegration.new
  end
  ...
  describe 'test an instance of SlackAppIntegration' do
    it 'should create an instance of SlackAppIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SlackAppIntegration)
    end
  end
  ...
  describe 'test attribute "use_slack_buttons"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

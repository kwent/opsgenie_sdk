...
# Unit tests for OpsgenieSdk::OpsGenieIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OpsGenieIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::OpsGenieIntegration.new
  end
  ...
  describe 'test an instance of OpsGenieIntegration' do
    it 'should create an instance of OpsGenieIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::OpsGenieIntegration)
    end
  end

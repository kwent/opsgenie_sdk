...
# Unit tests for OpsgenieSdk::CreateTeamRolePayload
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateTeamRolePayload' do
  before do
    # run before each test
    @instance = OpsgenieSdk::CreateTeamRolePayload.new
  end
  ...
  describe 'test an instance of CreateTeamRolePayload' do
    it 'should create an instance of CreateTeamRolePayload' do
      expect(@instance).to be_instance_of(OpsgenieSdk::CreateTeamRolePayload)
    end
  end

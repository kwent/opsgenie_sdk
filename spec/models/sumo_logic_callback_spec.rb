...
# Unit tests for OpsgenieSdk::SumoLogicCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SumoLogicCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SumoLogicCallback.new
  end
  ...
  describe 'test an instance of SumoLogicCallback' do
    it 'should create an instance of SumoLogicCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SumoLogicCallback)
    end
  end

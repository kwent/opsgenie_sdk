...
# Unit tests for OpsgenieSdk::BlueMatadorIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BlueMatadorIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::BlueMatadorIntegration.new
  end
  ...
  describe 'test an instance of BlueMatadorIntegration' do
    it 'should create an instance of BlueMatadorIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::BlueMatadorIntegration)
    end
  end

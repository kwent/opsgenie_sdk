...
# Unit tests for OpsgenieSdk::StatusyIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusyIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::StatusyIntegration.new
  end
  ...
  describe 'test an instance of StatusyIntegration' do
    it 'should create an instance of StatusyIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::StatusyIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::NagiosBasedV2Callback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NagiosBasedV2Callback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::NagiosBasedV2Callback.new
  end
  ...
  describe 'test an instance of NagiosBasedV2Callback' do
    it 'should create an instance of NagiosBasedV2Callback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::NagiosBasedV2Callback)
    end
  end

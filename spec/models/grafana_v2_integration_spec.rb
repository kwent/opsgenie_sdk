...
# Unit tests for OpsgenieSdk::GrafanaV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GrafanaV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::GrafanaV2Integration.new
  end
  ...
  describe 'test an instance of GrafanaV2Integration' do
    it 'should create an instance of GrafanaV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::GrafanaV2Integration)
    end
  end

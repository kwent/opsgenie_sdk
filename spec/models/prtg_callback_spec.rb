...
# Unit tests for OpsgenieSdk::PrtgCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PrtgCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::PrtgCallback.new
  end
  ...
  describe 'test an instance of PrtgCallback' do
    it 'should create an instance of PrtgCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::PrtgCallback)
    end
  end
  ...
  describe 'test attribute "passhash"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "prtg_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

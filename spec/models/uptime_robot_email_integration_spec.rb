...
# Unit tests for OpsgenieSdk::UptimeRobotEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UptimeRobotEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::UptimeRobotEmailIntegration.new
  end
  ...
  describe 'test an instance of UptimeRobotEmailIntegration' do
    it 'should create an instance of UptimeRobotEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::UptimeRobotEmailIntegration)
    end
  end

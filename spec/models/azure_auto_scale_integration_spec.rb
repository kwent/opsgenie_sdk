...
# Unit tests for OpsgenieSdk::AzureAutoScaleIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AzureAutoScaleIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AzureAutoScaleIntegration.new
  end
  ...
  describe 'test an instance of AzureAutoScaleIntegration' do
    it 'should create an instance of AzureAutoScaleIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AzureAutoScaleIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::NeustarIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NeustarIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::NeustarIntegration.new
  end
  ...
  describe 'test an instance of NeustarIntegration' do
    it 'should create an instance of NeustarIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::NeustarIntegration)
    end
  end

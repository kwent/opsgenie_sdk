...
# Unit tests for OpsgenieSdk::StatusPageIOIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusPageIOIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::StatusPageIOIntegration.new
  end
  ...
  describe 'test an instance of StatusPageIOIntegration' do
    it 'should create an instance of StatusPageIOIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::StatusPageIOIntegration)
    end
  end

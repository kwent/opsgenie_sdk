...
# Unit tests for OpsgenieSdk::IncomingCallIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IncomingCallIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::IncomingCallIntegration.new
  end
  ...
  describe 'test an instance of IncomingCallIntegration' do
    it 'should create an instance of IncomingCallIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::IncomingCallIntegration)
    end
  end

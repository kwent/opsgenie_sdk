...
# Unit tests for OpsgenieSdk::IcingaCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IcingaCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::IcingaCallback.new
  end
  ...
  describe 'test an instance of IcingaCallback' do
    it 'should create an instance of IcingaCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::IcingaCallback)
    end
  end

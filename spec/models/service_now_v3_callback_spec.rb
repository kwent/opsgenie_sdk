...
# Unit tests for OpsgenieSdk::ServiceNowV3Callback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceNowV3Callback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ServiceNowV3Callback.new
  end
  ...
  describe 'test an instance of ServiceNowV3Callback' do
    it 'should create an instance of ServiceNowV3Callback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ServiceNowV3Callback)
    end
  end

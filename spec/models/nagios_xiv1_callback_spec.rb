...
# Unit tests for OpsgenieSdk::NagiosXIV1Callback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NagiosXIV1Callback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::NagiosXIV1Callback.new
  end
  ...
  describe 'test an instance of NagiosXIV1Callback' do
    it 'should create an instance of NagiosXIV1Callback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::NagiosXIV1Callback)
    end
  end

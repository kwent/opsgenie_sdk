...
# Unit tests for OpsgenieSdk::BMCRemedyCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BMCRemedyCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::BMCRemedyCallback.new
  end
  ...
  describe 'test an instance of BMCRemedyCallback' do
    it 'should create an instance of BMCRemedyCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::BMCRemedyCallback)
    end
  end
  ...
  describe 'test attribute "midtier_server_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

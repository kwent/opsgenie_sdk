...
# Unit tests for OpsgenieSdk::HipChatIntegrationV2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HipChatIntegrationV2' do
  before do
    # run before each test
    @instance = OpsgenieSdk::HipChatIntegrationV2.new
  end
  ...
  describe 'test an instance of HipChatIntegrationV2' do
    it 'should create an instance of HipChatIntegrationV2' do
      expect(@instance).to be_instance_of(OpsgenieSdk::HipChatIntegrationV2)
    end
  end

...
# Unit tests for OpsgenieSdk::OpsviewIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OpsviewIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::OpsviewIntegration.new
  end
  ...
  describe 'test an instance of OpsviewIntegration' do
    it 'should create an instance of OpsviewIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::OpsviewIntegration)
    end
  end

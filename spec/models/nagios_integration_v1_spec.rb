...
# Unit tests for OpsgenieSdk::NagiosIntegrationV1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NagiosIntegrationV1' do
  before do
    # run before each test
    @instance = OpsgenieSdk::NagiosIntegrationV1.new
  end
  ...
  describe 'test an instance of NagiosIntegrationV1' do
    it 'should create an instance of NagiosIntegrationV1' do
      expect(@instance).to be_instance_of(OpsgenieSdk::NagiosIntegrationV1)
    end
  end

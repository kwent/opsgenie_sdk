...
# Unit tests for OpsgenieSdk::XmppCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XmppCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::XmppCallback.new
  end
  ...
  describe 'test an instance of XmppCallback' do
    it 'should create an instance of XmppCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::XmppCallback)
    end
  end

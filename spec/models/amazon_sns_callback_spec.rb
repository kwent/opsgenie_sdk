...
# Unit tests for OpsgenieSdk::AmazonSnsCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonSnsCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AmazonSnsCallback.new
  end
  ...
  describe 'test an instance of AmazonSnsCallback' do
    it 'should create an instance of AmazonSnsCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AmazonSnsCallback)
    end
  end
  ...
  describe 'test attribute "new_conf_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

...
# Unit tests for OpsgenieSdk::LightstepIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LightstepIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::LightstepIntegration.new
  end
  ...
  describe 'test an instance of LightstepIntegration' do
    it 'should create an instance of LightstepIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::LightstepIntegration)
    end
  end

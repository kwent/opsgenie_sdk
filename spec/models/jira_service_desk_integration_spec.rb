...
# Unit tests for OpsgenieSdk::JiraServiceDeskIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JiraServiceDeskIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::JiraServiceDeskIntegration.new
  end
  ...
  describe 'test an instance of JiraServiceDeskIntegration' do
    it 'should create an instance of JiraServiceDeskIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::JiraServiceDeskIntegration)
    end
  end

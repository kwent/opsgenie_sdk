...
# Unit tests for OpsgenieSdk::DnsCheckIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DnsCheckIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::DnsCheckIntegration.new
  end
  ...
  describe 'test an instance of DnsCheckIntegration' do
    it 'should create an instance of DnsCheckIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::DnsCheckIntegration)
    end
  end

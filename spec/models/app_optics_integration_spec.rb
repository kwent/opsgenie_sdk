...
# Unit tests for OpsgenieSdk::AppOpticsIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AppOpticsIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AppOpticsIntegration.new
  end
  ...
  describe 'test an instance of AppOpticsIntegration' do
    it 'should create an instance of AppOpticsIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AppOpticsIntegration)
    end
  end

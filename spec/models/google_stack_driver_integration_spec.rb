...
# Unit tests for OpsgenieSdk::GoogleStackDriverIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoogleStackDriverIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::GoogleStackDriverIntegration.new
  end
  ...
  describe 'test an instance of GoogleStackDriverIntegration' do
    it 'should create an instance of GoogleStackDriverIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::GoogleStackDriverIntegration)
    end
  end

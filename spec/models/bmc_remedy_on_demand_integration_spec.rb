...
# Unit tests for OpsgenieSdk::BMCRemedyOnDemandIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BMCRemedyOnDemandIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::BMCRemedyOnDemandIntegration.new
  end
  ...
  describe 'test an instance of BMCRemedyOnDemandIntegration' do
    it 'should create an instance of BMCRemedyOnDemandIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::BMCRemedyOnDemandIntegration)
    end
  end

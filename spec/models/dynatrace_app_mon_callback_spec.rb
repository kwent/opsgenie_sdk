...
# Unit tests for OpsgenieSdk::DynatraceAppMonCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DynatraceAppMonCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::DynatraceAppMonCallback.new
  end
  ...
  describe 'test an instance of DynatraceAppMonCallback' do
    it 'should create an instance of DynatraceAppMonCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::DynatraceAppMonCallback)
    end
  end

...
# Unit tests for OpsgenieSdk::RollbarIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RollbarIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::RollbarIntegration.new
  end
  ...
  describe 'test an instance of RollbarIntegration' do
    it 'should create an instance of RollbarIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::RollbarIntegration)
    end
  end

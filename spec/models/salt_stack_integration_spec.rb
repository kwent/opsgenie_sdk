...
# Unit tests for OpsgenieSdk::SaltStackIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SaltStackIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SaltStackIntegration.new
  end
  ...
  describe 'test an instance of SaltStackIntegration' do
    it 'should create an instance of SaltStackIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SaltStackIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::ZapierIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZapierIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ZapierIntegration.new
  end
  ...
  describe 'test an instance of ZapierIntegration' do
    it 'should create an instance of ZapierIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ZapierIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::BigPandaIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BigPandaIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::BigPandaIntegration.new
  end
  ...
  describe 'test an instance of BigPandaIntegration' do
    it 'should create an instance of BigPandaIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::BigPandaIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::RaygunIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RaygunIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::RaygunIntegration.new
  end
  ...
  describe 'test an instance of RaygunIntegration' do
    it 'should create an instance of RaygunIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::RaygunIntegration)
    end
  end

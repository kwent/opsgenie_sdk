...
# Unit tests for OpsgenieSdk::AlertSiteIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AlertSiteIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AlertSiteIntegration.new
  end
  ...
  describe 'test an instance of AlertSiteIntegration' do
    it 'should create an instance of AlertSiteIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AlertSiteIntegration)
    end
  end

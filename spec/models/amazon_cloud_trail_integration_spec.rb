...
# Unit tests for OpsgenieSdk::AmazonCloudTrailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonCloudTrailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AmazonCloudTrailIntegration.new
  end
  ...
  describe 'test an instance of AmazonCloudTrailIntegration' do
    it 'should create an instance of AmazonCloudTrailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AmazonCloudTrailIntegration)
    end
  end

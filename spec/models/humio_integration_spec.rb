...
# Unit tests for OpsgenieSdk::HumioIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HumioIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::HumioIntegration.new
  end
  ...
  describe 'test an instance of HumioIntegration' do
    it 'should create an instance of HumioIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::HumioIntegration)
    end
  end

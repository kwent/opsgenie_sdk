...
# Unit tests for OpsgenieSdk::WhatsUpGoldIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WhatsUpGoldIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::WhatsUpGoldIntegration.new
  end
  ...
  describe 'test an instance of WhatsUpGoldIntegration' do
    it 'should create an instance of WhatsUpGoldIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::WhatsUpGoldIntegration)
    end
  end

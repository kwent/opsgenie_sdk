...
# Unit tests for OpsgenieSdk::ManageEngineIntegrationDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ManageEngineIntegrationDTO' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ManageEngineIntegrationDTO.new
  end
  ...
  describe 'test an instance of ManageEngineIntegrationDTO' do
    it 'should create an instance of ManageEngineIntegrationDTO' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ManageEngineIntegrationDTO)
    end
  end

...
# Unit tests for OpsgenieSdk::ConnectWiseIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConnectWiseIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ConnectWiseIntegration.new
  end
  ...
  describe 'test an instance of ConnectWiseIntegration' do
    it 'should create an instance of ConnectWiseIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ConnectWiseIntegration)
    end
  end

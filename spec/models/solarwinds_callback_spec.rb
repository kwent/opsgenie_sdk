...
# Unit tests for OpsgenieSdk::SolarwindsCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SolarwindsCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SolarwindsCallback.new
  end
  ...
  describe 'test an instance of SolarwindsCallback' do
    it 'should create an instance of SolarwindsCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SolarwindsCallback)
    end
  end

...
# Unit tests for OpsgenieSdk::CloudSploitIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CloudSploitIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::CloudSploitIntegration.new
  end
  ...
  describe 'test an instance of CloudSploitIntegration' do
    it 'should create an instance of CloudSploitIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::CloudSploitIntegration)
    end
  end

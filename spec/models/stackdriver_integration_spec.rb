...
# Unit tests for OpsgenieSdk::StackdriverIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StackdriverIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::StackdriverIntegration.new
  end
  ...
  describe 'test an instance of StackdriverIntegration' do
    it 'should create an instance of StackdriverIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::StackdriverIntegration)
    end
  end

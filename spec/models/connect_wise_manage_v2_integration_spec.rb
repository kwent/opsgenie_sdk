...
# Unit tests for OpsgenieSdk::ConnectWiseManageV2Integration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConnectWiseManageV2Integration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ConnectWiseManageV2Integration.new
  end
  ...
  describe 'test an instance of ConnectWiseManageV2Integration' do
    it 'should create an instance of ConnectWiseManageV2Integration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ConnectWiseManageV2Integration)
    end
  end

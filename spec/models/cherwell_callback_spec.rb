...
# Unit tests for OpsgenieSdk::CherwellCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CherwellCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::CherwellCallback.new
  end
  ...
  describe 'test an instance of CherwellCallback' do
    it 'should create an instance of CherwellCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::CherwellCallback)
    end
  end

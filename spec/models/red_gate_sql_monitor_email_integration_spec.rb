...
# Unit tests for OpsgenieSdk::RedGateSqlMonitorEmailIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RedGateSqlMonitorEmailIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::RedGateSqlMonitorEmailIntegration.new
  end
  ...
  describe 'test an instance of RedGateSqlMonitorEmailIntegration' do
    it 'should create an instance of RedGateSqlMonitorEmailIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::RedGateSqlMonitorEmailIntegration)
    end
  end

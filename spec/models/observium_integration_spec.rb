...
# Unit tests for OpsgenieSdk::ObserviumIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ObserviumIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ObserviumIntegration.new
  end
  ...
  describe 'test an instance of ObserviumIntegration' do
    it 'should create an instance of ObserviumIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ObserviumIntegration)
    end
  end

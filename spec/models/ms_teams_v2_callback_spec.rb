...
# Unit tests for OpsgenieSdk::MSTeamsV2Callback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MSTeamsV2Callback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::MSTeamsV2Callback.new
  end
  ...
  describe 'test an instance of MSTeamsV2Callback' do
    it 'should create an instance of MSTeamsV2Callback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::MSTeamsV2Callback)
    end
  end

...
# Unit tests for OpsgenieSdk::GitHubIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GitHubIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::GitHubIntegration.new
  end
  ...
  describe 'test an instance of GitHubIntegration' do
    it 'should create an instance of GitHubIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::GitHubIntegration)
    end
  end

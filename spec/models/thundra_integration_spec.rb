...
# Unit tests for OpsgenieSdk::ThundraIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ThundraIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ThundraIntegration.new
  end
  ...
  describe 'test an instance of ThundraIntegration' do
    it 'should create an instance of ThundraIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ThundraIntegration)
    end
  end

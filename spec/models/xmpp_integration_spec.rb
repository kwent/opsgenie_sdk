...
# Unit tests for OpsgenieSdk::XmppIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'XmppIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::XmppIntegration.new
  end
  ...
  describe 'test an instance of XmppIntegration' do
    it 'should create an instance of XmppIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::XmppIntegration)
    end
  end

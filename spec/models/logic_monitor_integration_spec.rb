...
# Unit tests for OpsgenieSdk::LogicMonitorIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LogicMonitorIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::LogicMonitorIntegration.new
  end
  ...
  describe 'test an instance of LogicMonitorIntegration' do
    it 'should create an instance of LogicMonitorIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::LogicMonitorIntegration)
    end
  end

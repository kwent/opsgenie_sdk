...
# Unit tests for OpsgenieSdk::HPServiceManagerCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HPServiceManagerCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::HPServiceManagerCallback.new
  end
  ...
  describe 'test an instance of HPServiceManagerCallback' do
    it 'should create an instance of HPServiceManagerCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::HPServiceManagerCallback)
    end
  end
  ...
  describe 'test attribute "api_ket"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

...
# Unit tests for OpsgenieSdk::OECIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OECIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::OECIntegration.new
  end
  ...
  describe 'test an instance of OECIntegration' do
    it 'should create an instance of OECIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::OECIntegration)
    end
  end

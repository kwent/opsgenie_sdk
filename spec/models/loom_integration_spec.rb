...
# Unit tests for OpsgenieSdk::LoomIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LoomIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::LoomIntegration.new
  end
  ...
  describe 'test an instance of LoomIntegration' do
    it 'should create an instance of LoomIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::LoomIntegration)
    end
  end

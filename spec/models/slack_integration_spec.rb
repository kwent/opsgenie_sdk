...
# Unit tests for OpsgenieSdk::SlackIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SlackIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SlackIntegration.new
  end
  ...
  describe 'test an instance of SlackIntegration' do
    it 'should create an instance of SlackIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SlackIntegration)
    end
  end

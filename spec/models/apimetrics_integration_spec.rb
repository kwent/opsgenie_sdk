...
# Unit tests for OpsgenieSdk::ApimetricsIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApimetricsIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ApimetricsIntegration.new
  end
  ...
  describe 'test an instance of ApimetricsIntegration' do
    it 'should create an instance of ApimetricsIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ApimetricsIntegration)
    end
  end

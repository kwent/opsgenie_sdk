...
# Unit tests for OpsgenieSdk::MagentrixIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MagentrixIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::MagentrixIntegration.new
  end
  ...
  describe 'test an instance of MagentrixIntegration' do
    it 'should create an instance of MagentrixIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::MagentrixIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::SplunkITSICallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SplunkITSICallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::SplunkITSICallback.new
  end
  ...
  describe 'test an instance of SplunkITSICallback' do
    it 'should create an instance of SplunkITSICallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::SplunkITSICallback)
    end
  end

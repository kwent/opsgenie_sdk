...
# Unit tests for OpsgenieSdk::CodeshipIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CodeshipIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::CodeshipIntegration.new
  end
  ...
  describe 'test an instance of CodeshipIntegration' do
    it 'should create an instance of CodeshipIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::CodeshipIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::AmazonSecurityHubIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonSecurityHubIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::AmazonSecurityHubIntegration.new
  end
  ...
  describe 'test an instance of AmazonSecurityHubIntegration' do
    it 'should create an instance of AmazonSecurityHubIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::AmazonSecurityHubIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::FreshserviceCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FreshserviceCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::FreshserviceCallback.new
  end
  ...
  describe 'test an instance of FreshserviceCallback' do
    it 'should create an instance of FreshserviceCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::FreshserviceCallback)
    end
  end

...
# Unit tests for OpsgenieSdk::CloudWatchEventsIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CloudWatchEventsIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::CloudWatchEventsIntegration.new
  end
  ...
  describe 'test an instance of CloudWatchEventsIntegration' do
    it 'should create an instance of CloudWatchEventsIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::CloudWatchEventsIntegration)
    end
  end

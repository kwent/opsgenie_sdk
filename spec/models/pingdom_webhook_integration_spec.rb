...
# Unit tests for OpsgenieSdk::PingdomWebhookIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PingdomWebhookIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::PingdomWebhookIntegration.new
  end
  ...
  describe 'test an instance of PingdomWebhookIntegration' do
    it 'should create an instance of PingdomWebhookIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::PingdomWebhookIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::ApicaIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApicaIntegration' do
  before do
    # run before each test
    @instance = OpsgenieSdk::ApicaIntegration.new
  end
  ...
  describe 'test an instance of ApicaIntegration' do
    it 'should create an instance of ApicaIntegration' do
      expect(@instance).to be_instance_of(OpsgenieSdk::ApicaIntegration)
    end
  end

...
# Unit tests for OpsgenieSdk::TrackItCallback
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackItCallback' do
  before do
    # run before each test
    @instance = OpsgenieSdk::TrackItCallback.new
  end
  ...
  describe 'test an instance of TrackItCallback' do
    it 'should create an instance of TrackItCallback' do
      expect(@instance).to be_instance_of(OpsgenieSdk::TrackItCallback)
    end
  end
